...
export const PRODUCT_CATEGORIES: ProductCategory[] = [
  ...
  // ─────────────────────────────────────────────────────────────── KILIM RUGS
  {
    ...
    gallery: gallery(
      ['/images/rug5.webp', '/images/rug3.webp', '/images/tgi-banner-3.webp'],
      'Kilim Rug',
      ['Tribal kilim rug living room', 'Geometric kilim pattern detail', 'Reversible kilim close-up', 'Contemporary kilim bedroom', 'Bold motif kilim carpet', 'Kilim loom weaving Bhadohi', 'Layered kilim interior', 'Neutral kilim runner', 'Colourful kilim collection', 'Boutique kilim suite', 'Wool kilim texture', 'Kilim rug finishing'],
    ),
  },

...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Tapis Global International is a made-to-order carpet and rug manufacturer in Bhadohi, India, supplying commercial buyers and projects pan-India — Delhi NCR, Mumbai, Bengaluru, Hyderabad, Chennai and more. Custom carpets for architects, hotels, developers and procurement. Not a ready-stock retailer.',
...
const PAGE_JSONLD = JSON.stringify(
  buildJsonLd(
    webPageSchema({
      ...
      description: 'Made-to-order carpet and rug manufacturer in Bhadohi supplying commercial buyers and projects pan-India.',

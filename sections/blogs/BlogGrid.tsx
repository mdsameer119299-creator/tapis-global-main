    ...
    <section className="px-12 max-lg:px-6 py-16 lg:py-24" style={{ background: 'var(--iv)' }}>
      <div className="max-w-6xl mx-auto">
        <Reveal>
          ...
          <p className="text-[15px] font-light leading-[1.85] max-w-2xl mb-12" style={{ color: 'var(--inkm)' }}>
            ...
            <Reveal key={post.slug} delay={i * 60}>
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  />
                  <span
                    className="absolute top-4 left-4 px-3 py-1 text-[9px] tracking-[0.22em] uppercase font-medium"
                ...
                <div className="flex flex-col flex-1 p-6">
                  <p className="text-[11px] tracking-[0.12em] uppercase mb-3" style={{ color: 'var(--inkl)' }}>
                  ...
                  <p className="text-[14px] font-light leading-[1.75] mb-5 flex-1" style={{ color: 'var(--inkm)' }}>
                    {post.excerpt}
                  </p>
                  <Link
                    href={`/blogs#${post.slug}`}
                    className="inline-flex items-center gap-2 text-[11px] tracking-[0.18em] uppercase font-medium transition-colors duration-300 group-hover:text-[var(--c)]"
                    style={{ color: 'var(--gd)' }}
                  >
                    Read Article
